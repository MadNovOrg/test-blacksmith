...
import { UncompletedList } from '@app/modules/course_details/course_certification_tab/components/UncompletedList/UncompletedList'
import { ModuleObject } from '@app/modules/course_details/course_certification_tab/pages/CourseCertification/types'

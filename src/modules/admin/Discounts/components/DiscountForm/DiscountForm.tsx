...
import { FreePlacesDiscount, PercentDiscount } from './components'
import {
  AMOUNT_PRESET_VALUE,
  AMOUNT_PRESETS,
  APPLIES_TO,
...
export const DiscountForm: React.FC<React.PropsWithChildren> = () => {
      ...
      <Stack gap={3} flex={1} sx={{ p: 4, backgroundColor: '#fff' }}>
        ...
        <Box>
          ...
          <PercentDiscount
            ...
            amountRadioChange={amountRadioChange}
            register={register}
            formState={formState}
          />
          <FreePlacesDiscount

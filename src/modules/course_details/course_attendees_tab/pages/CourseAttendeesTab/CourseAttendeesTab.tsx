...
import { CourseInvites } from '../../components/CourseInvites'
...
> = ({ course }) => {
  ...
  const filterForBookingContact = (courseType: Course_Type_Enum) => {
    return acl.isBookingContact() && courseType === Course_Type_Enum.Open
  ...
  const {
    ...
    ...filterForBookingContact(course.type),
  })

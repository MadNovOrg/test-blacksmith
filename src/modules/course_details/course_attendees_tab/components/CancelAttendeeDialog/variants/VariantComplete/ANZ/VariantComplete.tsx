...
import {
  ...
  Title,
} from '@app/modules/course_details/course_attendees_tab/components/CancelAttendeeDialog/components'
import { FormInput } from '@app/modules/course_details/course_attendees_tab/components/CancelAttendeeDialog/types'
...
export const VariantComplete = ({
  ...
  const useGST = isAustraliaCountry(course.residingCountry ?? 'AU')
                ...
                <InfoRow
                  ...
                  value={t('currency', {
                    amount: values.cancellationFee
                      ? new Big((values.cancellationFee * 10) / 100)
                          .round(2)
                          .toNumber()
                      : '0',

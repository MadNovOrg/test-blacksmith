...
import { GET_EVALUATIONS_SUMMARY_QUERY } from '@app/modules/course_evaluation/queries/get-evaluations-summary'
import { SummaryDocument } from '@app/pages/trainer-pages/CourseDetails/components/SummaryDocument/SummaryDocument'

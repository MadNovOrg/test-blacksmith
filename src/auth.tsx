...
export const SessionProvider = ({
  ...
  const login = async (
    ...
    try {
      ...
      // can happen if new password required  - we have a session but cannot login
      if (session.signInUserSession === null) {
        return { error: { code: 401, message: 'New password required' } }
      }

import { unauthorizedTest as test } from '../../fixtures/auth'
...
test('reset password: too short', async ({ resetPasswordPage }) => {
  test.skip(true, 'Skipped till the functionality is ready')
  await resetPasswordPage.submitPasswords('abc', 'abc')
  await resetPasswordPage.checkPasswordError('Password is too short')
})

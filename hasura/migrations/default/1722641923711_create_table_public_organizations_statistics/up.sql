...
CREATE OR REPLACE TRIGGER course_certificate_trigger_status
...
CREATE OR REPLACE TRIGGER course_certificate_hold_request_trigger_status
AFTER INSERT OR UPDATE
...
CREATE OR REPLACE TRIGGER organization_member_trigger_organizations_statistics
...
-- PROFILE TRIGGER
CREATE OR REPLACE TRIGGER profile_trigger_organizations_statistics
    AFTER UPDATE
    ON profile
    FOR EACH ROW
...
CREATE OR REPLACE TRIGGER certification_trigger_organizations_statistics
...
CREATE OR REPLACE TRIGGER course_participant_trigger_organizations_statistics
    AFTER UPDATE

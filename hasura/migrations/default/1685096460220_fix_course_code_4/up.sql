UPDATE course_level_prefix SET prefix = 'BILD_REGULAR' WHERE name = 'B';
UPDATE course_level_prefix SET prefix = 'BILD_INTERMEDIATE_TRAINER' WHERE name = 'B.INT';
UPDATE course_level_prefix SET prefix = 'BILD_ADVANCED_TRAINER' WHERE name = 'B.ADV';

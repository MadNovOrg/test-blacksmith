...
DROP TABLE "public"."course_participant_module";
...
alter table "public"."course_participant" add column "graded" bool null;

alter table "public"."course_participant" drop constraint "course_participant_grade_fkey";

alter table "public"."course_participant" drop column "grade";
alter table "public"."course_participant" drop column "grading_feedback";

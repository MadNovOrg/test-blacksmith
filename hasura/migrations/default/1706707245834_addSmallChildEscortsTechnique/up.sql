...
('Small child escorts','THEORY',(SELECT id FROM module_group WHERE name = 'Small Child and One Person Holds' AND course_level = 'LEVEL_1'), 'LEVEL_1'),
('Small child escorts','THEORY',(SELECT id FROM module_group WHERE name = 'Small Child and One Person Holds' AND course_level = 'LEVEL_2'), 'LEVEL_2'),
('Small child escorts','THEORY',(SELECT id FROM module_group WHERE name = 'Small Child and One Person Holds' AND course_level = 'INTERMEDIATE_TRAINER'), 'INTERMEDIATE_TRAINER'),
('Small child escorts','THEORY',(SELECT id FROM module_group WHERE name = 'Small Child and One Person Holds' AND course_level = 'ADVANCED_TRAINER'), 'ADVANCED_TRAINER');

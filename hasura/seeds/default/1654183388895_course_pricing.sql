...
('OPEN', 'FOUNDATION_TRAINER_PLUS', false, false, 1295, 'FTP.OP'),
('OPEN', 'FOUNDATION_TRAINER_PLUS', false, true, 600, 'FTP.RE.OP'),
...
('CLOSED', 'LEVEL_1_BS', false, false, 101, 'LEVEL1.BS.CL'), -- 28
('CLOSED', 'LEVEL_1_BS', true, false, 101, 'LEVEL1.BS.CL'), -- 29
('CLOSED', 'LEVEL_1_BS', false, true, 101, 'LEVEL1.BS.RE.CL'), -- 30
('CLOSED', 'LEVEL_1_BS', true, true, 101, 'LEVEL1.BS.RE.CL'); -- 31

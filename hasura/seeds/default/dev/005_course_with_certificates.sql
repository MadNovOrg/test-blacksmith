...
INSERT INTO public.course_certificate (course_id, profile_id, number, expiry_date, course_name, course_level, certification_date, is_revoked, blended_learning, reaccreditation, course_accredited_by)
SELECT 10011 as course_id, participant.profile_id as profile_id, 'L1.F.OP.10011' as number,
       ...
       false as blended_learning, false as reaccreditation, 'ICM' as course_accredited_by
FROM public.course_participant participant
JOIN public.course course ON participant.course_id = course.id

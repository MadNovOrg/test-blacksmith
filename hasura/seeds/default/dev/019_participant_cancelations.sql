INSERT INTO public.course (id, name, course_type, course_delivery_type, course_level, reaccreditation, go1_integration, course_status, grading_confirmed, min_participants, max_participants, accredited_by, organization_id, modules_duration) VALUES
(10027, 'Positive Behaviour Training: Level One', 'OPEN', 'F2F', 'LEVEL_1', false, false, 'CONFIRM_MODULES', false, 5, 10, 'ICM', null, 305);

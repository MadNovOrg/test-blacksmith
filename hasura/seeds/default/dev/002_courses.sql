...
(10003, 'Some description.', 'Positive Behaviour Training: Level One', 'OPEN', 'F2F', 'LEVEL_1', null, false, false, 'DECLINED', false, 'ICM'),
(10004, 'Very long description of the course.', 'Positive Behaviour Training: Level Two', 'OPEN', 'F2F', 'LEVEL_2', null, false, false, 'GRADE_MISSING', false, 'ICM'),
(10005, 'Very long description of the course.', 'Positive Behaviour Training: Advanced Modules', 'CLOSED', 'F2F', 'ADVANCED', 'c43b2ba0-8630-43e5-9558-f59ee9a224f0', false, false, 'DRAFT', false, 'ICM'),
(10006, 'Some description.', 'Positive Behaviour Training: Level One', 'CLOSED', 'F2F', 'LEVEL_1', null, false, true, 'EVALUATION_MISSING', true, 'ICM'),
(10007, 'Very long description of the course.', 'Positive Behaviour Training: Level Two', 'CLOSED', 'F2F', 'LEVEL_2', 'c43b2ba0-8630-43e5-9558-f59ee9a224f0', false, true, 'EVALUATION_MISSING', false, 'ICM'),
(10008, 'Very long description of the course.', 'Positive Behaviour Training: Advanced Modules', 'CLOSED', 'F2F', 'ADVANCED', 'c43b2ba0-8630-43e5-9558-f59ee9a224f0', false, true, 'CONFIRM_MODULES', false, 'ICM'),
(10009, 'Some description.', 'Positive Behaviour Training: Level One', 'INDIRECT', 'VIRTUAL', 'LEVEL_1', 'c43b2ba0-8630-43e5-9558-f59ee9a224f0', false, false, 'APPROVAL_PENDING', false, 'ICM'),
(10010, 'Empty course for trainer certificates', 'Positive Behaviour Trainer: Advanced', 'CLOSED', 'F2F', 'ADVANCED_TRAINER', 'c43b2ba0-8630-43e5-9558-f59ee9a224f0', false, false, 'SCHEDULED', false, 'ICM'),
(10011, 'Course completed in the past', 'Positive Behaviour Training: Level One', 'OPEN', 'F2F', 'LEVEL_1', 'c43b2ba0-8630-43e5-9558-f59ee9a224f0', false, false, 'COMPLETED', true, 'ICM'),
(10081, 'Closed course level one virtual', 'Positive Behaviour Training: Level One', 'CLOSED', 'VIRTUAL', 'LEVEL_1', 'c43b2ba0-8630-43e5-9558-f59ee9a224f0', false, false, 'TRAINER_PENDING', true, 'ICM'),
(10082, 'Indirect course level two', 'Positive Behaviour Training: Level Two', 'INDIRECT', 'F2F', 'LEVEL_2', 'c43b2ba0-8630-43e5-9558-f59ee9a224f0', false, false, 'SCHEDULED', true, 'ICM'),
(10083, 'Trainer missing course.', 'Positive Behaviour Training: Intermediate Trainer', 'OPEN', 'F2F', 'INTERMEDIATE_TRAINER', '55320dc6-cfb0-41fb-9000-ca7eb9d2894d', false, false, 'TRAINER_MISSING', false, 'ICM'),
(10084, 'cancelled course.', 'Positive Behaviour Training: Level One', 'OPEN', 'VIRTUAL', 'LEVEL_1', '55320dc6-cfb0-41fb-9000-ca7eb9d2894d', false, false, 'CANCELLED', false, 'ICM');

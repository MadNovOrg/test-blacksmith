...
('5dd7b79c-9ef2-4712-833e-e2f12bdd672d', '1981-08-01', 'TeamTeach', 'Advanced-Trainer', 'tt.adv.trainer@teamteach.testinator.com', '+44 55 5555 5555', 'England', 'GB-ENG', 'CEO'),
('749791ef-e4c4-4a5f-881a-461e4724138d', '1981-08-01', 'TeamTeach', 'Intermediate-Trainer', 'tt.int.trainer@teamteach.testinator.com', '+44 55 5555 5555', 'England', 'GB-ENG', 'CEO'),
('6ea4e91b-9856-4533-9544-949caba236fb', '1981-08-01', 'TeamTeach', 'Exp-Adv-Trainer', 'tt.expired.adv.trainer@teamteach.testinator.com', '+44 55 5555 5555', 'England', 'GB-ENG', 'CEO'),
('30f8fdda-a7ec-44d5-afa0-26d5147d0ea5', '1981-08-01', 'TeamTeach', 'Exp-Int-Trainer', 'tt.expired.int.trainer@teamteach.testinator.com', '+44 55 5555 5555', 'England', 'GB-ENG', 'CEO'),
('88072bb2-10e0-4417-b9ce-ec05265b8b56', '1981-08-01', 'TeamTeach', 'Principal-Trainer', 'tt.principal.trainer@teamteach.testinator.com', '+44 55 5555 5555', 'England', 'GB-ENG', 'CEO'),
('dccd780a-9745-4972-a43e-95ec3ef361df', '1981-08-01', 'TeamTeach', 'Senior-Trainer', 'tt.senior.trainer@teamteach.testinator.com', '+44 55 5555 5555', 'England', 'GB-ENG', 'CEO'),
('6407ca25-d1d2-4a3d-863a-4b2a0a56c0e4', '1981-08-01', 'TeamTeach', 'Booking-Contact', 'tt.booking@teamteach.testinator.com', '+44 55 5555 5555', 'England', 'GB-ENG', 'CEO');

INSERT INTO identity (profile_id, provider_id, type) VALUES
...
-- trainers
('467b4ac5-d86e-40ee-b25f-87e4ed2ce618', (SELECT id from role WHERE name = 'booking-contact')),
('5dd7b79c-9ef2-4712-833e-e2f12bdd672d', (SELECT id from role WHERE name = 'trainer')),
('749791ef-e4c4-4a5f-881a-461e4724138d', (SELECT id from role WHERE name = 'trainer')),
...
INSERT INTO profile_trainer_role_type (profile_id, trainer_role_type_id) VALUES
...
INSERT INTO organization_member (organization_id, profile_id, is_admin) VALUES

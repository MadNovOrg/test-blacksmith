...
values ('1e345ec4-f99f-4ce7-b765-ee2d36d7f400', 10101, 'L2.F.CL.10101', NOW() + interval '12 months', '117c12fc-d7c6-4987-9841-a499765ade4b', 'Positive Behaviour Training: Level Two', 'LEVEL_2', NOW() - interval '12 months', false),
       ...
       ('1e345ec4-f99f-4ce7-b765-ee2d36d7f406', 10103, 'INT.F.CL.10103', NOW() + interval '12 months', 'b9bea8d0-cde4-4c01-94e2-d6bcf56dcd0e', 'Positive Behaviour Training: Intermediate Trainer ', 'INTERMEDIATE_TRAINER', NOW() - interval '12 months', false),
       ('1e345ec4-f99f-4ce7-b765-ee2d36d7f407', 10103, 'INT.F.CL.10103', NOW() - interval '20 days', '38290d3f-7614-44be-ac70-cd0db7b71b1e', 'Positive Behaviour Training: Intermediate Trainer ', 'INTERMEDIATE_TRAINER', NOW() - interval '24 months', false),

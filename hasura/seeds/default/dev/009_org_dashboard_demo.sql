...
values  ('Positive Behaviour Training: Level Two ', 'CLOSED', 'F2F', 'LEVEL_2', 'd787defd-481c-414b-95ff-ecbcc12ae500',
       ...
       ('Positive Behaviour Training: Advanced Modules ', 'CLOSED', 'F2F', 'ADVANCED',
        ...
        0, '810A May23', null, null, false, 455, 'ICM', 0),
...
insert into public.course_certificate (id, course_id, number, expiry_date, profile_id, course_name, course_level, certification_date, is_revoked, blended_learning, reaccreditation, course_accredited_by)
values ('1e345ec4-f99f-4ce7-b765-ee2d36d7f400', 10101, 'L2.F.CL.10101', NOW() + interval '12 months', '117c12fc-d7c6-4987-9841-a499765ade4b', 'Positive Behaviour Training: Level Two', 'LEVEL_2', NOW() - interval '12 months', false, false, false, 'ICM'),
       ('1e345ec4-f99f-4ce7-b765-ee2d36d7f401', 10101, 'L2.F.CL.10101', NOW() + interval '12 months', '95e897bf-6d61-43d5-9c5c-efc0d0a5aaed', 'Positive Behaviour Training: Level Two', 'LEVEL_2', NOW() - interval '12 months', false, false, false, 'ICM'),
       ('1e345ec4-f99f-4ce7-b765-ee2d36d7f402', 10101, 'L2.F.CL.10101', NOW() + interval '12 months', '38290d3f-7614-44be-ac70-cd0db7b71b1e', 'Positive Behaviour Training: Level Two', 'LEVEL_2', NOW() - interval '17 months', false, false, false, 'ICM'),
       ('1e345ec4-f99f-4ce7-b765-ee2d36d7f403', 10102, 'ADVMOD.F.CL.10102', NOW() - interval '5 days', '117c12fc-d7c6-4987-9841-a499765ade4b', 'Positive Behaviour Training: Advanced Modules', 'ADVANCED', NOW() - interval '24 months', false, false, false, 'ICM'),
       ('1e345ec4-f99f-4ce7-b765-ee2d36d7f404', 10102, 'ADVMOD.F.CL.10102', NOW() - interval '5 days', '95e897bf-6d61-43d5-9c5c-efc0d0a5aaed', 'Positive Behaviour Training: Advanced Modules ', 'ADVANCED', NOW() - interval '24 months', false, false, false, 'ICM'),
       ('1e345ec4-f99f-4ce7-b765-ee2d36d7f405', 10102, 'ADVMOD.F.CL.10102', NOW() + interval '8 days', '38290d3f-7614-44be-ac70-cd0db7b71b1e', 'Positive Behaviour Training: Advanced Modules ', 'ADVANCED', NOW() - interval '24 months', false, false, false, 'ICM'),
       ('1e345ec4-f99f-4ce7-b765-ee2d36d7f406', 10103, 'INT.F.CL.10103', NOW() + interval '12 months', 'b9bea8d0-cde4-4c01-94e2-d6bcf56dcd0e', 'Positive Behaviour Training: Intermediate Trainer ', 'INTERMEDIATE_TRAINER', NOW() - interval '12 months', false, false, false, 'ICM'),
       ('1e345ec4-f99f-4ce7-b765-ee2d36d7f407', 10103, 'INT.F.CL.10103', NOW() - interval '20 days', '38290d3f-7614-44be-ac70-cd0db7b71b1e', 'Positive Behaviour Training: Intermediate Trainer ', 'INTERMEDIATE_TRAINER', NOW() - interval '24 months', false, false, false, 'ICM'),
       ('1e345ec4-f99f-4ce7-b765-ee2d36d7f408', 10104, 'L1.F.CL.10104', NOW() + interval '6 months', '85687c6e-d8a4-4e98-a47e-a66c8059919b', 'Positive Behaviour Training: Level One ', 'LEVEL_1', NOW() - interval '18 months', false, false, false, 'ICM'),
       ('1e345ec4-f99f-4ce7-b765-ee2d36d7f409', 10104, 'L1.F.CL.10104', NOW() - interval '1 day', '49f34a78-a73d-46c3-a17f-5cee00feb1ca', 'Positive Behaviour Training: Level One ', 'LEVEL_1', NOW() - interval '12 months', false, false, false, 'ICM');
...
values ('2022-12-06 12:42:07.622554 +00:00', '117c12fc-d7c6-4987-9841-a499765ade4b', true, '', 'PASS', NOW() - interval '12 months', 10101, '1e345ec4-f99f-4ce7-b765-ee2d36d7f400', true, true),
       ('2022-12-06 12:42:07.622554 +00:00', '95e897bf-6d61-43d5-9c5c-efc0d0a5aaed', true, '', 'PASS', NOW() - interval '12 months', 10101, '1e345ec4-f99f-4ce7-b765-ee2d36d7f401', true, true),
       ('2022-12-06 12:42:07.622554 +00:00', '38290d3f-7614-44be-ac70-cd0db7b71b1e', true, '', 'PASS', NOW() - interval '17 months', 10101, '1e345ec4-f99f-4ce7-b765-ee2d36d7f402', true, true),
       ('2022-12-06 12:42:07.622554 +00:00', '117c12fc-d7c6-4987-9841-a499765ade4b', true, '', 'PASS', NOW() - interval '24 months', 10102, '1e345ec4-f99f-4ce7-b765-ee2d36d7f403', true, true),
       ('2022-12-06 12:42:07.622554 +00:00', '95e897bf-6d61-43d5-9c5c-efc0d0a5aaed', true, '', 'PASS', NOW() - interval '24 months', 10102, '1e345ec4-f99f-4ce7-b765-ee2d36d7f404', true, true),
       ('2022-12-06 12:42:07.622554 +00:00', '38290d3f-7614-44be-ac70-cd0db7b71b1e', true, '', 'PASS', NOW() - interval '24 months', 10102, '1e345ec4-f99f-4ce7-b765-ee2d36d7f405', true, true),
       ('2022-12-06 12:42:07.622554 +00:00', 'b9bea8d0-cde4-4c01-94e2-d6bcf56dcd0e', true, '', 'ASSIST_ONLY', NOW() - interval '12 months', 10103, '1e345ec4-f99f-4ce7-b765-ee2d36d7f406', true, true),
       ('2022-12-06 12:42:07.622554 +00:00', '38290d3f-7614-44be-ac70-cd0db7b71b1e', true, '', 'PASS', NOW() - interval '24 months', 10103, '1e345ec4-f99f-4ce7-b765-ee2d36d7f407', true, true),
       ('2022-12-06 12:42:07.622554 +00:00', '85687c6e-d8a4-4e98-a47e-a66c8059919b', true, '', 'PASS', NOW() - interval '18 months', 10104, '1e345ec4-f99f-4ce7-b765-ee2d36d7f408', true, true),
       ('2022-12-06 12:42:07.622554 +00:00', '49f34a78-a73d-46c3-a17f-5cee00feb1ca', true, '', 'PASS', NOW() - interval '12 months', 10104, '1e345ec4-f99f-4ce7-b765-ee2d36d7f409', true, true);

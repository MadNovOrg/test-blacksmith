...
- 60cfea6: Synchronize Go1 user account data whenever a Connect course participant is added to or removed from a blended learning course.
- 5fe0948: feat (TTHP-5267): mcm prices update
- 26e5e46: feat (TTHP-5054): forbid trainers, org admins and key contacts from inviting users considered _TT clients_ to indirect courses ( TT Clients - users that attended a Open or Closed L1/L2/L1Bs course in the past 36 months or attends one in the future 12 months )
